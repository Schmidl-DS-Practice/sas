...
*     ParkCode and ParkType have a length of 200, which   *;
...
/* Note: When the SCAN function creates a new column, the new column will have the same length */
/* as the column listed as the first argument.  */
